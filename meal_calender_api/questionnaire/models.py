...
class UserProfile(models.Model):
    ...
    meal_plan_repetition = models.IntegerField(
    ...
    cooking_skill = models.CharField(
        max_length=20, choices=COOKING_SKILL_CHOICES, default="intermediate"
    )
    ...
    measuring_standard = models.CharField(
        max_length=10, choices=MEASURING_STANDARD_CHOICES, default="metric"
    )
